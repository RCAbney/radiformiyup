                        ...
                        <ul role="list" className="-mx-2 space-y-1">
                            {menuItems.map((menuItem, index) => {
                                return (
                                    <li key={menuItem}>
                                        <button
                                            className={`text-sky-950 group flex items-center w-full gap-x-3 rounded-md p-2 text-sm leading-6 hover:bg-slate-200 ${
                                                index === activeFormNavSection
                                                    ? "font-semibold bg-slate-300 hover:bg-slate-300"
                                                    : ""
                                            }`}
                                            onClick={() =>
                                        ...
                                        >
                                            {menuItem}
                                            {/* will need to be able to access error object and render error icon per pertinent section? */}
                                            {hasError && (
